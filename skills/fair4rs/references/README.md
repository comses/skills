# FAIR4RS + SMP Companion References

This directory contains companion references for generating publication-readiness outputs with explicit Software Management Plan (SMP) support.
...
- `EVERSE-SMP-REFRESH-POLICY.md`:
  Defines a practical refresh cadence and review checklist to keep SMP guidance aligned with evolving EVERSE recommendations.

- `FAIR4RS-SMP-CROSSWALK.md`:
  Maps FAIR4RS publication readiness deliverables to SMP lifecycle sections so teams can produce coherent, non-duplicative plans.
